...
public class RecipeIngredientLocalDomainDataAccess implements DomainDataAccessRecipeIngredient {

    private static volatile RecipeIngredientLocalDomainDataAccess INSTANCE;
    private AppExecutors appExecutors;
    private RecipeIngredientEntityDao dao;

    private RecipeIngredientLocalDomainDataAccess(@Nonnull AppExecutors appExecutors,
                                                  @Nonnull RecipeIngredientEntityDao dao) {
        this.appExecutors = appExecutors;
        this.dao = dao;
    }

    public static RecipeIngredientLocalDomainDataAccess getInstance(
            @Nonnull AppExecutors appExecutors,
            @Nonnull RecipeIngredientEntityDao dao) {
        if (INSTANCE == null) {
            synchronized (RecipeIngredientLocalDomainDataAccess.class) {
                if (INSTANCE == null)
                    INSTANCE = new RecipeIngredientLocalDomainDataAccess(appExecutors, dao);
            }
        }
        return INSTANCE;
    }
