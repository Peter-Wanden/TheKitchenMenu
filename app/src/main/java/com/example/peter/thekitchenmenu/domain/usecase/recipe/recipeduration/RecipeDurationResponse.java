...
public final class RecipeDurationResponse extends RecipeResponse<RecipeDurationResponse.Model> {
    ...
    public static final class Model extends RecipeResponseModel {
        ...
        public static class Builder extends RecipeResponseModelBuilder<
                Builder, RecipeDurationResponse.Model> {

            public Builder() {
                model = new RecipeDurationResponse.Model();
            }
