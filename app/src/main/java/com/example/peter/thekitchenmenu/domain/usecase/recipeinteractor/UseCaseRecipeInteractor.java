package com.example.peter.thekitchenmenu.domain.usecase.recipeinteractor;

/**
 * A recipe is made up of a complex set of independently changing data structures each controlled by
 * its own use case.
 * The {@link UseCaseRecipeInteractor} acts as a mediator between the use cases.
 ...
 * rule.
 */
public class UseCaseRecipeInteractor {
