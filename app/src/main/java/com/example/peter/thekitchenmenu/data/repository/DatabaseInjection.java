...
public class DatabaseInjection {
    ...
    public static RecipeMetadataUseCaseDataAccess provideRecipeMetadataDataSource(@Nonnull Context c) {
        return RecipeMetadataUseCaseDataAccess.getInstance(
    ...
    public static RecipeCourseUseCaseDataAccess provideRecipeCourseDataSource(
            @Nonnull Context c) {
        return RecipeCourseUseCaseDataAccess.getInstance(
    ...
    public static RecipePortionsUseCasseDataAccess provideRecipePortionsDataSource(
            @Nonnull Context c) {

        return RecipePortionsUseCasseDataAccess.getInstance(
