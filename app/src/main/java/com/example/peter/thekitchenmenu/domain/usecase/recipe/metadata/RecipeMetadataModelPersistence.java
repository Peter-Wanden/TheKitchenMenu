 ...
 */
public final class RecipeMetadataModelPersistence extends BasePersistence {
    ...
    private RecipeMetadataModelPersistence(){}
    ...
    public static class Builder extends DomainModelBuilder<
                    Builder,
            RecipeMetadataModelPersistence> {

        public Builder() {
            model = new RecipeMetadataModelPersistence();
        }
