...
/**
 * This is the ProductMy model. A POJO made flexible with Firebase and Room annotations along with
 * a fully parcelable implementation.
 */
@Entity(tableName = Constants.TABLE_PRODUCT_MY)
public class ProductMy implements Parcelable {
     ...
     * @param communityProductId {@link ProductCommunity} foreign key.
     * @param fbUsedProductsUserKey Keeps a count of times a products is used in Firebase.
     * @param fbProductReferenceKey The {@link ProductCommunity} to which this product relates to.
    ...
    public static final Creator<ProductMy> CREATOR = new Creator<ProductMy>() {
        @Override
        public ProductMy createFromParcel(Parcel in) {
            return new ProductMy(in);
        }

        @Override
        public ProductMy[] newArray(int size) {
            return new ProductMy[size];
        }
    };
