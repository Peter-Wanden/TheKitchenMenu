...
public class AdapterCatProd
        extends
        RecyclerView.Adapter<AdapterCatProd.AdapterCatProdViewHolder> {

    private static final String LOG_TAG = AdapterCatProd.class.getSimpleName();
    ...
    /* Constructor */
    public AdapterCatProd(
            Context context,
            AdapterCatProdClickHandler clickHandler) {
