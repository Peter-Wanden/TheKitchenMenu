...
public final class RecipeDurationModelPersistence
    ...
    private RecipeDurationModelPersistence() {}
    ...
    public boolean equals(Object o) {
        ...
        RecipeDurationModelPersistence that = (RecipeDurationModelPersistence) o;
    ...
    public static class Builder
            extends DomainModelBuilder<Builder, RecipeDurationModelPersistence> {

        public Builder() {
            model = new RecipeDurationModelPersistence();
        }
        ...
        public Builder basedOnPersistenceModel(
                @Nonnull RecipeDurationModelPersistence m) {
