...
public class SaveAdapter {
    ...
    public void adaptAndSave(@Nonnull RecipeMetadataModelPersistence model) {
        saveParentEntity(model);
        saveComponentStates(model);
        saveFailReasons(model);
    }

    private void saveParentEntity(RecipeMetadataModelPersistence model) {
    ...
    private void saveComponentStates(RecipeMetadataModelPersistence model) {
    ...
    private void saveFailReasons(RecipeMetadataModelPersistence model) {
