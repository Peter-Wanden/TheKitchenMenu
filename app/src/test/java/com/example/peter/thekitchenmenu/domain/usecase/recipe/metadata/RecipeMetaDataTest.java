...
public class RecipeMetaDataTest {
    ...
    @Mock
    RepositoryRecipeMetaData repoRecipeMetadataMock;
    @Captor
    ArgumentCaptor<PrimitiveDataSource.GetEntityCallback<RecipeMetadataEntity>> repoMetadataCallback;
    @Mock
    ...
    public void newId_databaseCalled_responseDATA_UNAVAILABLE() {
        // Arrange
        String recipeId = TestDataRecipeMetaDataEntity.getNewInvalid().getId();
        // Act
