...
public class RecipeIdentityTest {
    ...
    public void existingId_titleTooShortDescriptionDefault_stateINVALID_UNCHANGED() {
        ...
        // Assert state
        assertEquals(RecipeStateCalculator.ComponentState.INVALID_UNCHANGED, onErrorResponse.getState());
    }
    ...
    public void existingId_titleValidDescriptionDefault_stateVAILD_UNCHANGED() {
        ...
        // Assert state
        assertEquals(RecipeStateCalculator.ComponentState.VALID_UNCHANGED, onSuccessResponse.getState());
    }
