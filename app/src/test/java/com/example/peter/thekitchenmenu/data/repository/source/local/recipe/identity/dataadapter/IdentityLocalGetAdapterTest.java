...
public class IdentityLocalGetAdapterTest {
    ...
    private GetAllModelsCallbackClient getAllCallbackClient;
    ...
    public void getAllByDomainId_returnAllModelsForDomainId () {
        // Arrange
        getAllCallbackClient = new GetAllModelsCallbackClient();
    ...
    private static class GetAllModelsCallbackClient
        ...
        private static final String TAG = IdentityLocalGetAdapterTest.TAG +
                GetAllModelsCallbackClient.class.getSimpleName() + ": ";
