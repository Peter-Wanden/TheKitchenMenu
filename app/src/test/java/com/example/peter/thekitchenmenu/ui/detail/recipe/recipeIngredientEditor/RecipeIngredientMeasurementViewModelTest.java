...
public class RecipeIngredientMeasurementViewModelTest {
    ...
    @Mock
    UseCasePortion useCasePortionMock;
    @Mock
    ...
    public void startRecipeIdIngredientId_correctIdsSentToUseCase() {
        ...
        // Assert
        verify(useCasePortionMock).start(recipeIdCaptor.capture(), ingredientIdCaptor.capture());
    ...
    public void startRecipeIdIngredientId_emptyModelNotSentToUseCase() {
        ...
        verify(useCasePortionMock, never()).processModel(anyObject());
    }
    ...
    public void startRecipeIngredientId_existingValuesSetToDisplay() {
        ...
        // Assert
        verify(useCasePortionMock).start(eq(QUANTITY_EXISTING_VALID_METRIC.getId()));
