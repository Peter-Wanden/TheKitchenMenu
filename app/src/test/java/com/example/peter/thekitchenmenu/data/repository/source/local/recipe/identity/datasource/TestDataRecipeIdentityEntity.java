...
public class TestDataRecipeIdentityEntity {
    ...
    public static RecipeIdentityEntity getInvalidNewEmpty() {
        return convertModelToEntity(
                TestDataRecipeIdentity.getNewInvalidActiveDefault()
        );
    }
    ...
    public static List<RecipeIdentityEntity> getAllByDomainId(String domainId) {
        List<RecipeIdentityEntity> entities = new ArrayList<>();
        for (RecipeIdentityUseCasePersistenceModel m : TestDataRecipeIdentity.getAllByDomainId(domainId)) {
            entities.add(convertModelToEntity(m)
            );
        }
        return entities;
    ...
    public static List<RecipeIdentityEntity> getValidIdentityEntities() {
        List<RecipeIdentityEntity> entities = new ArrayList<>();
        for (RecipeIdentityUseCasePersistenceModel m : TestDataRecipeIdentity.getAllValidModels()) {
            entities.add(convertModelToEntity(m));
        }
        return entities;
    }
    ...
    public static List<RecipeIdentityEntity> getAll() {
        List<RecipeIdentityEntity> entities = new ArrayList<>();
        for (RecipeIdentityUseCasePersistenceModel m : TestDataRecipeIdentity.getAll()) {
            entities.add(convertModelToEntity(m));
        }
        return entities;
    }

    private static RecipeIdentityEntity convertModelToEntity(RecipeIdentityUseCasePersistenceModel m) {
